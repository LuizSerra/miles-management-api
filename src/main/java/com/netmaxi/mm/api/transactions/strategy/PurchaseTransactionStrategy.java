...
public class PurchaseTransactionStrategy implements TransactionStrategy {
	...
	public PurchaseTransactionStrategy(ProgramRepository programRepository, UserRepository userRepository,
	...
	public Transaction execute(TransactionRequestDTO transactionRequestDTO) {
		log.info("TRANSACTION PURCHASE:::START");
		...
		log.info("TRANSACTION PURCHASE:::USER FOUND: {}", user);
		...
		log.info("TRANSACTION PURCHASE::: PROGRAM SENDER FOUND: {}", sender);
		...
		log.info("TRANSACTION PURCHASE:::END:::TRANSACTION: {}", transaction);
		return transaction;
	}
